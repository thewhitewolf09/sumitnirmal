...
export const SkillsData = [
  ...
  {
    name: "Node.js",
    icon: <DiNodejs color='#000000dc' />,
    link: "https://nodejs.org/",
  },
  {
    name: "C",
    icon: <SiCoursera color='#000000dc' />,
  ...
  },
  {
    ...
    icon : <SiVisualstudio color='#000000dc' />,
  ...
  },
  {
    ...
    icon : <SiMicrosoftoffice color='#000000dc' />,
